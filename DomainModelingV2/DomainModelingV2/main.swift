...
public class Person : CustomStringConvertible {
    ...
    public func toString() -> String {
        return "[Person: firstName:\(firstName) lastName:\(lastName) age:\(age) job:\(jobString(_job)) spouse:\(_spouce)]"
    }
    
    func jobString(job : Job?) -> String {
        if job != nil {
